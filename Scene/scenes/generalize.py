...
# keyframePath = "./Scene/target/extern/bunny/dummy/bunny_v534.1_trajectory.pt"

model_names = ["dilo3.1k.1.node"]
keyframePath = "./Scene/target/extern/dilo3.1k_dummy/dilo3.3k.1_trajectory.pt"
...
result_path = "./Scene/result/SNH_750_2250_dt01_bunny/win_1_2500_relaxation4__15iter_15to5"

load_path = "./Scene/result/SNH_500_10000_dt006/999999999.pt"
# load_path = "./Scene/result/SNH_750_1750_dt01/999999999.pt"
